local MODNAME	= "EPGPLootMaster"
local addon		= LibStub("AceAddon-3.0"):GetAddon("EPGPLootMaster")
...
local function fullOptions()
	if not options then
		options = {
			...
			--guiInline = true,
			name = MODNAME,
			get = function(i) return addon.db.profile[i[#i]] end,
			set = function(i, v) addon.db.profile[i[#i]] = v end,
			args = {
				general = {
                    order = 1,
                    type = "group",
                    ...
                    args = {
                        use_epgplootmaster = {
			                ...
			                width = "double",
                            set = function(i, v) 
                                addon.db.profile.use_epgplootmaster = v;
                                if v == 'enabled' then
		...
		monitor = {
					...
					args = {
						...
						monitorIncomingThreshold = {
							...
							disabled = function(info) return not addon.db.profile.monitor end,
							values = {
						...
						monitorSendAssistantOnly = {
							type = "toggle",
							order = 3.2,
							disabled = function(info) return not addon.db.profile.monitorSend end,
							width = 'full',
						...
						hint = {
							order = 5,
							width = 'normal',
							hidden = function(info) return not addon.db.profile.monitorSend end,
							type = "description",
		...
		buttons = {
			...
			args = {
				...
				button1 = {
					type = "input",
					width = 'full',
					hidden = function(info) return addon.db.profile.buttonNum < 1 end,
				...
				button2 = {
					type = "input",
					width = 'full',
					hidden = function(info) return addon.db.profile.buttonNum < 2 end,
					dialogControl = "EPGPLMButtonConfigWidget",
					order = 1.2,
					name = "button2",
					desc = "Configure this selection button.",
				...
				button3 = {
					type = "input",
					width = 'full',
					hidden = function(info) return addon.db.profile.buttonNum < 3 end,
					dialogControl = "EPGPLMButtonConfigWidget",
					order = 1.3,
					name = "button3",
					desc = "Configure this selection button.",
				...
				button4 = {
					type = "input",
					width = 'full',
					hidden = function(info) return addon.db.profile.buttonNum < 4 end,
					dialogControl = "EPGPLMButtonConfigWidget",
					order = 1.4,
					name = "button4",
					desc = "Configure this selection button.",
				...
				button5 = {
					type = "input",
					width = 'full',
					hidden = function(info) return addon.db.profile.buttonNum < 5 end,
					dialogControl = "EPGPLMButtonConfigWidget",
					order = 1.5,
					name = "button5",
					desc = "Configure this selection button.",
				...
				button6 = {
					type = "input",
					width = 'full',
					hidden = function(info) return addon.db.profile.buttonNum < 6 end,
					dialogControl = "EPGPLMButtonConfigWidget",
					order = 1.6,
					name = "button6",
					desc = "Configure this selection button.",
				...
				button7 = {
					type = "input",
					width = 'full',
					hidden = function(info) return addon.db.profile.buttonNum < 7 end,
					dialogControl = "EPGPLMButtonConfigWidget",
					order = 1.7,
					name = "button7",
					desc = "Configure this selection button.",
				...
				btnTestPopup = {
					...
					func = function()
						...
						for i=1, addon.db.profile.buttonNum do
			...
			args = {
				...
				AutoShardGroup = {			
					...
					args = {
						...
						AutoShardLooterEnable = {
							type = "toggle",
							order = 1,
							width = 'full',
							name = "Enable autolooting of Legendaries?",
						},
						...
						AutoShardLooter = {
							...
							disabled = function(info) return (addon.db.profile.AutoLootThreshold or 0)==0 end,
							values = function()
								local names = {}
								local name;
				...
				AutoLootGroup = {
					...
					args = {
						...
						AutoLootEnable = {
							...
							order = 1,
							width = 'full',
							name = "Enable autolooting of items?",
						},
...
function addon:OnEnable()
	AceConfigReg:RegisterOptionsTable("EPGPLootMaster", fullOptions)
	self.optionsFrame = AceConfigDialog:AddToBlizOptions(MODNAME, nil, nil, "general")
	self:RegisterModuleOptions("Loot Menu", GetButtons(), "Loot Menu")
	self:RegisterModuleOptions("Automatic Actions", GetAutoloot(), "Automatic Actions")
	self:RegisterModuleOptions("Monitor", GetMonitor(), "Monitor Options")
